...
func TestInteraction(t *testing.T) {
	...
	junitReporter := reporters.NewJUnitReporter("../../reports/interaction-junit.xml")
	RunSpecsWithDefaultAndCustomReporters(t, "Interaction", []Reporter{junitReporter})
}

var _ = BeforeSuite(func(done Done) {
	var err error
	log := logger.WithName("interactionsetup")
